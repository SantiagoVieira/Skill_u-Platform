...
export default function LoginClient() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (data.user) {
      ...
      // Verificar ban antes de redirigir
      if (profile?.is_banned) {
        await supabase.auth.signOut();

        setError(
          `Tu cuenta ha sido suspendida.${profile.ban_reason ? ` Motivo: ${profile.ban_reason}.` : ""} Si consideras que esto es un error, escríbenos a soporte@skillu.com`,
        );
